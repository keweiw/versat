...
<script type="text/javascript" language="javascript">
	$(document).ready(function() {
		...
		$("#search").click(function() {
			$("#form").attr("action", "/versat/customer/trans/list");
			$("#form").submit();
		});
	});
</script>
...
<body>
	...
	<div class="header_container">
		<h1 class="header_logo">
			<a href="versat/customer/welcome">Carnegie Financial Service</a>
		</h1>
		<!--header right-->
...
<!-- Alert -->
	...
	<div class="content_left">
		...
		<div class="content_menu5 " id="sellLink">
			<a href="/versat/customer/fund/listownedfund">Sell Fund</a>
		</div>
		<div class="content_menubd"></div>
		<div class="content_menu4" id="researchLink">
			<a href="/versat/customer/fund/listallfund">Research Fund</a>
		</div>
		<div class="content_menubd"></div>
		<div class="content_menu_11 font14b" id="historyLink">
			<a href="/versat/customer/trans/list">Transaction History</a>
		</div>
		<div class="content_menubd"></div>
		...
		<div class="content_menu8" id="profileLink">
			<a href="/versat/customer/welcome">Profile</a>
		</div>
	</div>
	<!--content menu end-->
