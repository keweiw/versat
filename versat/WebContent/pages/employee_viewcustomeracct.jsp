...
<table cellspacing="0" cellpadding="0" class="http_content_detail">
  <tbody>
	<tr>
		...
		<td class="detail_right">Liaqu</td>
	</tr>
	<tr>
		<td class="detail_left">First Name:</td>
		<td class="detail_right">Lia</td>
	</tr>
	<tr>
		<td class="detail_left">Last Name:</td>
		<td class="detail_right">Qu</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="detail_right">Pittsburgh</td>
	</tr>
	<tr>
		<td class="detail_left">State：</td>
		<td class="detail_right">PA</td>
	</tr>
	<tr>
		<td class="detail_left">Zipcode：</td>
		<td class="detail_right">15213</td>
	</tr>
	<tr>
		<td class="detail_left">Cash Balance：</td>
		<td class="detail_right">$0.00</td>
	</tr>
  </tbody>
</table>
<div class="mail_search">
	<div class="new_user_save_button"><a class="btn_sprites" href="#" name="password"><span>Reset Password</span></a></div>					
</div>
</div>
<!--Create New customer-->			
</form>
